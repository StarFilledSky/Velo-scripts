...
-- @link https://starfilledsky.github.io/Velo-Docs/
--
-- CCollisionFilter doesn't get picked up for some reason :/
-- Nevermind it has 0 accessible children and therefor is not included.
-- I should make some sort of marker for that so it's easier to tell.
